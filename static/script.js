...
if (document.querySelector('title').text == "Portfolio"){
    ...
    const pageTitle = [['Overview', 'Tech Stack', 'Application Features', 'Interactive Quiz for User Preferences', 'Dynamically Generated Table of Top Counties', 'Graphical Display of County Statistics', 'Integration with 3rd Party API for Active Listings', 'Backend and Database Contributions', 'Relational Database Design: ER Diagram'],['Problem Statement', 'Main Objective', 'Instrumenting C Program with Sanitizer', 'LLVM Pass: Control Flow Diagram','E.g. Sanitizing a Vulnerable Program', 'Effect of Sanitizer on Vulnerable Program', 'Project Outcomes'],['<b>Background:</b> Surface Adhesion', 'Project Overview','SAP Surface Stratification', 'Surface Phase Properties', 'Surface Tunability via SAP Chemistry', 'Dynamic Texture with Water Exposure'],
...
if (document.querySelector('title').text == 'About Me'){
    ...
    hobbyWheel = document.querySelector('.static')
    let i = 0;
    let opacity = 0.6;
